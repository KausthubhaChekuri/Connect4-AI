...
def winning_move(board, piece):
    # Check for whether there are any horizontal locations for win
    ...
    # Check for whether there are any vertical locations for win
    ...
    # Check for diagonals that are positively sloped
    for c in range(number_of_columns - 3):
        for r in range(number_of_rows - 3):
    ...
    # Check for diagonals that are negatively sloped
    for c in range(number_of_columns - 3):
...
def score_position(board, piece):
    ...
    ## Score center column
    center_array = [int(i) for i in list(board[:, number_of_columns // 2])]
